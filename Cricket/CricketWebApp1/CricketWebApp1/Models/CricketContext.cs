        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Stadium>(entity =>
            {
                ...
                entity.HasOne(d => d.StadiumCountryNavigation)
                    ...
                    .HasConstraintName("FK__stadium__stadium__6477ECF3");
            });
        }
    }
}
